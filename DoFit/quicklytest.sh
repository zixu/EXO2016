...
python newstyle_B2GWW_doFit_class.py mu WprimeWZ800 700 900 40 150 600 1500 ExpN Pow -b -m 1  --category HP --closuretest 0  --realdata 1  --keepblind 0 -w 0 &
python newstyle_B2GWW_doFit_class.py el WprimeWZ800 700 900 40 150 600 1500 ExpN Pow -b -m 1  --category HP --closuretest 0  --realdata 1  --keepblind 0 -w 0 &
#python newstyle_B2GWW_doFit_class.py mu WprimeWZ4500 4400 4600 40 150 800 5000 ExpN Pow -b -m 1 --category HP --closuretest 0  --realdata 1  --keepblind 0 -w 1  &
#python newstyle_B2GWW_doFit_class.py el WprimeWZ4500 4400 4600 40 150 800 5000 ExpN Pow -b -m 1 --category HP --closuretest 0  --realdata 1  --keepblind 0 -w 1  &
